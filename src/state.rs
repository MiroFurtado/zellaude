...
pub struct State {
    ...
    /// Panes being renamed manually, mapped to their prior base name so
    /// cancellation or event-order races do not erase it.
    pub pending_manual_renames: HashMap<u32, String>,
}
